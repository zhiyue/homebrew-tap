...
class BirdRs < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/zhiyue/bird-rs/releases/download/v0.1.0/bird-rs-v0.1.0-aarch64-apple-darwin.tar.gz"
      sha256 "f03aaa20406c9191efed7dbebfe31cb04573b4074723e232d6dcc48d0c483f7d"
    end

    on_intel do
      url "https://github.com/zhiyue/bird-rs/releases/download/v0.1.0/bird-rs-v0.1.0-x86_64-apple-darwin.tar.gz"
